...
#ifndef MAX_GROUPS
#define MAX_GROUPS lightgraph::core::kMaxGroups
#endif

#ifndef MAX_LIGHT_LISTS
#define MAX_LIGHT_LISTS lightgraph::core::kMaxLightLists
#endif

#ifndef MAX_CONDITIONAL_WEIGHTS
#define MAX_CONDITIONAL_WEIGHTS lightgraph::core::kMaxConditionalWeights
#endif

#ifndef MAX_TOTAL_LIGHTS
#define MAX_TOTAL_LIGHTS lightgraph::core::kMaxTotalLights
#endif

#ifndef MAX_NOTES_SET
#define MAX_NOTES_SET lightgraph::core::kMaxNotesSet
#endif

#ifndef CONNECTION_MAX_MULT
#define CONNECTION_MAX_MULT lightgraph::core::kConnectionMaxMult
#endif

#ifndef CONNECTION_MAX_LIGHTS
#define CONNECTION_MAX_LIGHTS lightgraph::core::kConnectionMaxLights
#endif

#ifndef CONNECTION_MAX_LEDS
#define CONNECTION_MAX_LEDS lightgraph::core::kConnectionMaxLeds
#endif

#ifndef OUT_PORTS_MEMORY
#define OUT_PORTS_MEMORY lightgraph::core::kOutPortsMemory
#endif

#ifndef RANDOM_MODEL
#define RANDOM_MODEL lightgraph::core::kRandomModel
#endif

#ifndef RANDOM_SPEED
#define RANDOM_SPEED lightgraph::core::kRandomSpeed
#endif

#ifndef RANDOM_DURATION
#define RANDOM_DURATION lightgraph::core::kRandomDuration
#endif

#ifndef RANDOM_COLOR
#define RANDOM_COLOR lightgraph::core::kRandomColor
#endif

#ifndef INFINITE_DURATION
#define INFINITE_DURATION lightgraph::core::kInfiniteDuration
#endif

#ifndef DEFAULT_SPEED
#define DEFAULT_SPEED lightgraph::core::kDefaultSpeed
#endif
